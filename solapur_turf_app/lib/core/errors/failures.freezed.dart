...
class _$ValidationFailureImpl implements ValidationFailure {
  const _$ValidationFailureImpl(
      {required this.message, final List<String> errors = const []})
      : _errors = errors;
...
abstract class ValidationFailure implements Failure {
  const factory ValidationFailure(
      ...
      final List<String> errors}) = _$ValidationFailureImpl;
...
class _$ForbiddenFailureImpl implements ForbiddenFailure {
  const _$ForbiddenFailureImpl({required this.message});
